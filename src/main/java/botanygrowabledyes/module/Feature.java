...
import botanygrowabledyes.common.botanygrowabledyesrecipes;
...
public class Feature {
    ...
    public static void registerTile(Class<? extends TileEntity> clazz, String key) {
        GameRegistry.registerTileEntity(clazz, BotanyGrowableDyesMod.MODID + key);
    }

    public static IRecipe registerHardcoreRecipe(String ID, IRecipe recipe) {
        botanygrowabledyesrecipes.addHardcoreRecipe(ID, recipe);
        return recipe;
    }
