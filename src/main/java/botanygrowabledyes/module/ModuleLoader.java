...
import botanygrowabledyes.BotanyGrowableDyesMod;
...
public final class ModuleLoader {
    ...
    public static void preInit(FMLPreInitializationEvent event) {
        ...
        forEachModule(module -> FMLLog.info("Module " + module.name + " is " + (module.enabled ? "enabled" : "disabled")));
        Collections.sort(enabledModules, (a,b) -> Integer.compare(b.getPriority(),a.getPriority()));
        forEachEnabled(module -> {
            FMLLog.info("Module PreInit : " + module.name);
    ...
    public static class ChangeListener {
        ...
        public void onConfigChanged(ConfigChangedEvent.OnConfigChangedEvent eventArgs) {
            if (eventArgs.getModID().equals(BotanyGrowableDyesMod.MODID))
                loadModuleConfigs();
        }
